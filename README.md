# Angular + Webpack + Material design lite

This is a cloned project from https://github.com/AngularClass/NG6-starter with some added components in order to make it ready to roll with the help of Material design lite.

## Features:
* Best practices in directory/file organization for Angular (allowing for infinite horizontal app scaling)
* A ready-to-go build system for working with [ES6](https://git.io/es6features)
* Tasks for generating additional boilerplate Angular components
* A full testing system in place with Moka/Karma/Chai
